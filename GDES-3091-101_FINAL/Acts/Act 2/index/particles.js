...
(function(w) {
    ...
    */
    var mouse = {
        ...
        px: 0,
        py: 0,
        // TRUE FOR SIMPLY MOVING, FALSE FOR CLICK
        down: true 
    };
    ...
    */
    var canvas_width = 1250; //Needs to be a multiple of the resolution value below.
    var canvas_height = 1500; //This too.
    ...
    var speck_count = 7000; //This determines how many particles will be made.
